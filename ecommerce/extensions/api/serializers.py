...
class BasketSerializer(serializers.ModelSerializer):
    ...
    def get_payment_status(self, obj):
        successful_payment_notification = obj.paymentprocessorresponse_set.filter(
            Q(response__contains="u'decision': u'ACCEPT'") | Q(response__contains="u'state': u'approved'")
        )
        if successful_payment_notification:
            return "Accepted"
        return "Declined"
